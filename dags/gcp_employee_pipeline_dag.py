...
RAW_BUCKET = "april-raw-data-bucket"
PROCESSED_BUCKET = "april-processed-data-bucket"
...
with DAG(
    ...
    def push_input_path(**context):
        ...
        context['ti'].xcom_push(key='input_file_path', value=input_file)
    ...
    # Task 4: Dataproc PySpark Job
    PYSPARK_JOB = {
        "reference": {"project_id": PROJECT_ID},
        "placement": {"cluster_name": CLUSTER_NAME},
        "pyspark_job": {
            "main_python_file_uri": f"gs://{RAW_BUCKET}/scripts/employee_etl.py"
        }
    }
    ...
    # Task 5: Load Data from GCS to BigQuery
    load_to_bigquery = GCSToBigQueryOperator(
        task_id='load_gcs_to_bigquery',
        bucket=PROCESSED_BUCKET,
        source_objects=['output/employee_data_processed/*.parquet'],
    ...
    # Task 6: BigQuery Validation Query
    ...
    # DAG Flow
    check_gcs_file >> push_xcom_task >> read_xcom_task >> run_dataproc_job >> load_to_bigquery >> validation_query
